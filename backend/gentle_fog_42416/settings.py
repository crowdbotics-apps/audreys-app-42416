"""
Django settings for gentle_fog_42416 project.
...
ROOT_URLCONF = 'gentle_fog_42416.urls'
...
WSGI_APPLICATION = 'gentle_fog_42416.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_fog_42416 API",
    "DESCRIPTION": "API documentation for gentle_fog_42416 App",
    "VERSION": "v1",
}
